            ...
            <div className="flex-1 flex flex-col">
                    ...
                    <Group justify="space-between" align="flex-start" wrap="nowrap">
                        <Group gap="xs">
                            ...
                            <div className="flex-1! min-w-0!">
                                <Text size="md" fw={800} className="text-mine-shaft-50! group-hover:text-bright-sun-400! transition-colors! truncate! tracking-tight">
                                    {talent.name}
                                </Text>
                                <Text size="xs" fw={600} className="text-mine-shaft-300! truncate! opacity-80">
                        ...
                        </Group>
                        {
                            bookmarked ? (
                                <IconHeartFilled
                                    size={18}
                                    onClick={(e) => { e.preventDefault(); setBookmarked(false); }}
                                    className="text-red-500! cursor-pointer! shrink-0! hover:scale-110! transition-transform"
                                />
                            ) : (
                                <IconHeart
                                    size={18}
                                    onClick={(e) => { e.preventDefault(); setBookmarked(true); }}
                ...
                <Group gap={6} mb="sm" mt="xs">
                    ...
                    {talent.skills?.length > 3 && (
                        <Text size="10px" fw={700} className="text-bright-sun-400! ml-1">+{talent.skills.length - 3}</Text>
                    )}
                </Group>
                ...
                <Group justify="space-between" align="center" mb="md">
                    <Text size="sm" fw={800} className="text-bright-sun-400! drop-shadow-sm">
                        {talent.salary}
                    </Text>

                    <Group gap={4} align="center">
                        <IconMapPin size={12} className="text-bright-sun-400!" />
                        <Text size="10px" fw={700} className="text-mine-shaft-300! truncate max-w-[100px]">
                            {talent.location}
                        </Text>
                    </Group>
                </Group>
