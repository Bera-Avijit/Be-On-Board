...
import { User, isRecruiter } from "../../Data/User";
        ...
        <div className="flex flex-col items-start gap-4">
          ...
          <div className="flex flex-col items-start">
            <div className="flex items-center gap-3">
              <Text
                fw={900}
                className="text-4xl text-mine-shaft-50 tracking-tighter drop-shadow-md"
              >
                {talent.name}
              </Text>
              <Badge
                ...
                size="sm"
                radius="md"
                className="bg-bright-sun-400 text-mine-shaft-950 font-black"
              >
                PRO
              </Badge>
            </div>
            ...
            <div className="flex flex-col items-start gap-1 mt-2">
              <Group gap={6}>
                ...
                <Text size="lg" fw={700} className="text-mine-shaft-200">
                  {talent.role} •{" "}
                  <span className="text-bright-sun-300">{talent.company}</span>
                </Text>
              </Group>
              <Group gap={6}>
                <IconMapPin size={18} className="text-bright-sun-400" />
                <Text size="md" fw={600} className="text-mine-shaft-300">
                  {talent.location}
                </Text>
              </Group>
            </div>
