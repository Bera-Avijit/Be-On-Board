        ...
        >
            <div className="flex-1 flex flex-col">
                ...
                <Group gap={6} mb="md" wrap="nowrap">
                    <Badge color="yellow" variant="light" size="xs" radius="sm" className="bg-bright-sun-400/10! text-bright-sun-400! border! border-bright-sun-400/10! font-bold! shrink-0!">
                        {job.experience}
                    </Badge>
                    <Badge color="gray" variant="light" size="xs" radius="sm" className="bg-mine-shaft-900! text-mine-shaft-300! font-bold! shrink-0!">
                        {job.jobType}
                    </Badge>
                    <Badge
